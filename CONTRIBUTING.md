...
正文自由，一条约定：开头一段导语说清文章主张什么。来源不写在正文里，文章页底部自动渲染来源卡（作者、原文链接）；整篇译文在 frontmatter 标 `translated: true`，来源卡加「中文全译」标记。正文不写「来源与边界」一节，也不出现润色过程、收录经过一类读者不关心的过程性说明。`related` 挂关联的登记卡，文章页右栏互链。页面随首批文章一起构建，不留空归档页。
...
3. 正文开头一段导语说清主张。来源交给页面底部的来源卡，正文不写
   来源节，也不写润色过程一类过程性说明；译文在 frontmatter 标
...
中文成稿按 sepia 技术文章路线润色（professional-pass + tech-articles，中文加 zh 校准），成品不留润色痕迹，正文也不写评估过程。
