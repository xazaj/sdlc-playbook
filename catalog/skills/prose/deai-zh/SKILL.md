---
name: sdlc-deai-zh
description: 把一段现成的中文文字直接做白名单式去 AI 味改写时使用。触发场景包括：把这段中文改得像人写的、去掉这段话的 AI 腔、这段太像 AI 写的帮我改、帮我把这篇中文文章去 AI 味且信息一个字不能变。只处理中文一般文章的成稿；英文文本、发版说明/复盘/PR 回复等工程域文档、以及项目该装哪个去味技能的选型问题不在范围内。
version: 0.1.0
type: skill
stages: ["10-bootstrap"]
