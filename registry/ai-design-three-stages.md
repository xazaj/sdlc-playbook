...
**可信度需要说明。** 文章后半部分在付费墙之后。上面三阶段的骨架、种子串、雄心提示、评审子代理、图像与视频生成、做减法这六项来自可读部分，内容可靠。第七项标题为「移除 AI 痕迹」，正文读不到；我尝试过 RSS 全文、archive.today、作者本人 Substack、Lenny 官方开放的 markdown 归档仓库与多轮检索，均未取得原文。安装 prompt 中关于具体禁用项的那几条，是依据公开讨论中反复出现的共识特征补写的，不是原文转述。评审子代理的提问结构来自二手来源的转述，未经原文核对。
